...
module.exports = {
    /* 根目录 */
    webRoot: 'D:/OneDrive/repositories/ego/public/',
    /* 视图目录 */
    viewRoot: 'D:/OneDrive/repositories/ego/public/html/',
    /* 路由 */
    routes: {
    ...
    /* 同步模块mock数据路径 */
    mockTpl: 'D:/OneDrive/repositories/ego/mock.data/template/',
    /* 异步接口mock数据路径 */
    mockApi: 'D:/OneDrive/repositories/ego/mock.data/interface/',
    /* 是否修改代理的host */
    changeOrigin: true,
    /* 模板后缀 */
    viewExt: '.html',
